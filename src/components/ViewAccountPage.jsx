...
import { getCardData, submitPhoneNumber, getPublicSettings } from '../services/api';
...
const ViewAccountPage = () => {
    ...
    useEffect(() => {
        const loadData = async () => {
            // Also load WhatsApp setting
            getPublicSettings().then(data => {
                setShowWhatsAppButton(data.show_whatsapp_button !== false);
            }).catch(() => { });
