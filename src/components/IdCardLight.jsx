...
/**
 * ID Card Front Component - Light/Off-White Design
 * Elegant off-white card with gold accents and QR code (Apple ID branding).
 * Reuses the wallet light card CSS classes for an identical look.
 */
const IdCardLight = ({ card, showQR = true, qrLogo = null }) => {
